...
const NotSelectedForm = ({
  ...
  const getSelectedListData = async (id) => {
    await HTTP.get(`/production/byid/${id}`)
      .then((response) => {
  ...
  return (
    <>
      ...
      >
        {(formik) => (
          <Row className="mb-3 py-2 py-md-4 ">
            {loading ? (
              <Space size="middle">
                <Spin size="large" />
              </Space>
                      ...
                      <FormControl fullWidth>
                        ...
                        >
                          <MenuItem
                            ...
                            onClick={() => {
                              formik.setFieldValue("sentTo", "QandelBlbas");
                              setBuyer(false);
                            }}
                          >
                            {t("qandelblblas_store")}
                          </MenuItem>
                          <MenuItem
                            key="1"
                            value="Black Pipe Store"
                            onClick={() => {
                              formik.setFieldValue("sentTo", "BlackPipe");
                              setBuyer(false);
                            }}
                          >
                            {t("blackpipe_store")}
